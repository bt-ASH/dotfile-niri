tty(0.46.2)  都写一份REDME.md，并声明全程由Step 3.7 Flash生成# 鸣潮 (Wuthering Waves) 极致帧率优化配置
...
```bash
# 一键配置
/home/ash/dotfile-niri/WuWu-config/apply.sh

# 每次启动前
/home/ash/dotfile-niri/WuWu-config/set_gpu_perf.sh
```
