...
alias select-ssh='eval "$(ssh-agent -s)" && ssh-add ~/.ssh/mygit_key'
alias vrchat_pi='cd /home/ash/.local/share/Steam/steamapps/compatdata/438100/pfx/drive_c/users/steamuser/Pictures/VRChat'
#alias ff="fastfetch -c examples/14.jsonc  -l none" #Or --logo-type none
...
export qemu="/opt/unetlab/addons/qemu/"
export templates="/opt/unetlab/html/templates/"
export eve="root@192.168.122.62"
export pnet="root@192.168.122.61"
...
export OVERRIDE_TERMINAL_CMD="kitty --title eve-ng sh -c" #eve
# flatpak环境
...
# proxy_ip="192.168.115.172:3128"
# proxy_ip="http://192.168.0.4:3128"
...
export PATH=$PATH:~/Info-chan/navicat-premium-lite-cs/usr/bin
# >>> miyu zsh hook >>>
